...
namespace WarningReporting { 
    ...
    struct IWarningReportingUnit {
        ...
        virtual void ReportWarning(const char module[], const char fileName[], const uint32_t lineNumber, const char className[], const IWarning* const information) = 0;
        virtual bool IsDefaultCategory(const string& module, const string& category, bool& enabled) const = 0;
